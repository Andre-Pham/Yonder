...
enum YonderImages {
    ...
    static let cavernPlatformImage = YonderImage("CavernPlatform")
    static let shadowPlatformImage = YonderImage("ShadowPlatform")
    static let faction4PlatformImage = YonderImage("Faction4Platform")
    static let frostPlatformImage = YonderImage("FrostPlatform")
    static let faction6PlatformImage = Self.frostPlatformImage
    static let dungeonPlatformImage = YonderImage("DungeonPlatform")
    static let mechPlatformImage = YonderImage("MechPlatform")
    static let netherPlatformImage = YonderImage("NetherPlatform")
    static let faction2PlatformImage = YonderImage("Faction2Platform")
