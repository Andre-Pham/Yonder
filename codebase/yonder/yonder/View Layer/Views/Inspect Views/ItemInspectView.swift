            ...
            InspectStatsBody {
                if self.itemViewModel.damage > 0 {
                    if let foeViewModel = GameManager.instance.foeViewModel {
                        InspectStatView(
                            ...
                            value: self.itemViewModel.damage,
                            indicativeValue: self.playerViewModel.getIndicativeDamage(itemViewModel: self.itemViewModel,
                            opposition: foeViewModel),
                            image: self.itemViewModel.damageImage
                        )
                    } else {
                        InspectStatView(
                            title: Strings("stat.damage").local,
                            value: self.itemViewModel.damage,
                            indicativeValue: self.playerViewModel.getPassiveIndicativeDamage(itemViewModel: self.itemViewModel),
                            image: self.itemViewModel.damageImage
                        )
                    }
                }
                ...
                if self.itemViewModel.restoration > 0 {
                    InspectStatView(
                        ...
                        value: self.itemViewModel.restoration,
                        indicativeValue: self.playerViewModel.getIndicativeRestoration(of: self.itemViewModel),
                        image: self.itemViewModel.restorationImage
                    )
                }
                ...
                if self.itemViewModel.healthRestoration > 0 {
                    InspectStatView(
                        ...
                        value: self.itemViewModel.healthRestoration,
                        indicativeValue: self.playerViewModel.getIndicativeHealthRestoration(of: self.itemViewModel),
                        image: self.itemViewModel.healthRestorationImage
                    )
                }
                ...
                if self.itemViewModel.armorPointsRestoration > 0 {
                    InspectStatView(
                        ...
                        value: self.itemViewModel.armorPointsRestoration,
                        indicativeValue: self.playerViewModel.getIndicativeArmorPointsRestoration(of: self.itemViewModel),
                        image: self.itemViewModel.armorPointsRestorationImage
                    )
                }
                
                if self.itemViewModel.infiniteRemainingUses {
                    InspectStatusView(
                        title: self.itemViewModel.remainingUsesDescription,
                        status: Strings("item.infinite").local,
                        image: self.itemViewModel.remainingUsesImage
                    )
                } else {
                    InspectStatView(
                        title: self.itemViewModel.remainingUsesDescription,
                        value: self.itemViewModel.remainingUses,
                        image: self.itemViewModel.remainingUsesImage
                    )
                }
            }
