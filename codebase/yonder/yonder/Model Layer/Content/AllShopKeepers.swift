...
enum ShopKeepers {
    ...
    static func newTestShopKeeper() -> ShopKeeper {
        return ShopKeeper(purchasableItems: [
            ...
            PurchasableItem(item: Armor(name: "Strong Armor", description: "The toughest armor out there.", type: .body, armorPoints: 200, basePurchasePrice: 150, armorBuffs: [], equipmentPills: []), stock: 1),
