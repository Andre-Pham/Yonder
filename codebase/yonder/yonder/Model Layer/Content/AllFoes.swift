...
enum Foes {
    ...
    static func newTestFoe() -> Foe {
        ...
        lootBag1.addArmorLoot(ArmorAbstract(name: "Armor Loot", description: "Some weak armor.", type: .legs, armorPoints: 200, basePurchasePrice: 200, armorBuffs: [DamageBuff(sourceName: "Armor Loot", direction: .outgoing, duration: nil, damageDifference: 5)]))
