...
enum Foes {
    ...
    static func newRegularFoe(profile: FoeProfile, stage: Int, loot: LootOptions) -> Foe {
        let targetHealth = 150.0.compound(multiply: 1.4, index: stage).toRoundedInt()
    ...
    static func newRegularAcuteFoe(profile: FoeProfile, stage: Int, loot: LootOptions) -> Foe {
        let targetHealth = 60.0.compound(multiply: 1.4, index: stage).toRoundedInt()
        let targetDamage = 125.0.compound(multiply: 1.1, index: stage).toRoundedInt()
    ...
    static func newGoblinFoe(profile: FoeProfile, stage: Int, loot: LootOptions) -> Foe {
        let targetHealth = 120.0.compound(multiply: 1.4, index: stage).toRoundedInt()
        let targetDamage = 80.0.compound(multiply: 1.1, index: stage).toRoundedInt()
        let targetGold = 60.0.compound(multiply: 1.2, index: stage).toRoundedInt()
    ...
    static func newBruteFoe(profile: FoeProfile, stage: Int, loot: LootOptions) -> Foe {
        let targetHealth = 200.0.compound(multiply: 1.4, index: stage).toRoundedInt()
        let targetDamage = 35.0.compound(multiply: 1.1, index: stage).toRoundedInt()
