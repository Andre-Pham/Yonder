...
class WeaponFactory: BuildTokenFactory, RegionBasedFactory {
    ...
    private func replenishTokens() {
        ...
        newTokens.populate(count: 6, { .healthRestorationWeapon })
        newTokens.populate(count: 4, { .acuteHealthRestorationWeapon })
        newTokens.populate(count: 6, { .armorRestorationWeapon })
        newTokens.populate(count: 4, { .acuteArmorRestorationWeapon })
